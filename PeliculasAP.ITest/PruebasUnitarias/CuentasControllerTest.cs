...
{
    [TestClass]
    public class CuentasControllerTest:BasePrueba
    {
        [TestMethod]
        ...
        public async Task UsuarioNoPuedeLoguearse()
        {
            ...
            var userInfo = new UserInfoDTO() { Email = "ejemplo@hotmail.com", Password = "malPassword" };
        ...
        public async Task UsuarioPuedeLoguearse()
        {
            ...
            var controller = ConstruirCuentasController(nombreBD);
            var userInfo = new UserInfoDTO() { Email = "ejemplo@hotmail.com", Password = "Aa123456!" };
            var respuesta = await controller.Login(userInfo);
        ...
        //CODIGO OBTENIDO DE PAGINA OFICIAL DEL CODIGO FUENTE
